...
namespace ECommerce.Gateway.DelegateHandlers
{
    public class TokenExchangeDelegateHandler : DelegatingHandler
    {
        ...
        private async Task<string> GetToken(string requestToken)
        {
            ...
            TokenExchangeTokenRequest exchangeTokenRequest = new TokenExchangeTokenRequest()
            {
            ...
            var tokenResponse = await _httpClient.RequestTokenExchangeTokenAsync(exchangeTokenRequest);
