    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                //new ApiScope("catalog_read", "Full Access for Catalog API"), read write icin ayri olabilir
                ...
                //new ApiScope("discount_read", "Full Access for Discount API"),
                //new ApiScope("discount_write", "Full Access for Discount API"), client allowscopes a eklenmeli
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                //bilgiler veritbanindan alinabilir
                new Client
                {
